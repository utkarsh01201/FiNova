...
export default function BankAccountsPage() {
  ...
  const handleLinkSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMsg(
        err.message || 'Failed to link bank account'
      );
    } finally {
      setSubmitting(false);
    }
  ...
  const handleSetPrimary = async (accountId) => {
    try {
      ...
      alert(
        err.message || 'Failed to set primary bank account'
      );
    }
  };
  ...
  const handleWithdrawPin = async (pin) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setWithdrawSuccess(
          'Withdrawal successful! Bank balance updated.'
        );
      ...
      alert(
        err.message ||
        'Withdrawal failed. Check UPI PIN and wallet balance.'
      );
    } finally {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">
            Manage your bank accounts, check live balance with UPI PIN,
            and set primary payment source
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {accounts.map((acc) => {
            ...
            const hasVerifiedBalance =
              verifiedBalances[acc.id] !== undefined;
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xl font-mono tracking-widest font-extrabold">
      ...
      {isWithdrawModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl max-w-sm w-full p-6 shadow-2xl space-y-5">
            ...
            <p className="text-xs text-slate-400">
              Transfer funds from your Finova Wallet to your linked bank account.
              Your UPI PIN is required to authorize.
            </p>
